      ...
      <div className="min-w-xl">
        ...
        >
          ...
          {isEditing ? (
            ...
            // Non-editing Mode
            <>
              {/* Task Content and other buttons */}
              <div className="flex-1"> {/* This div wraps the title, description, and expand button */}
              ...
              <button
                ...
                className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors ml-auto"
              >
        ...
        {isExpanded && (
          <div style={{ marginLeft: `${(level + 1) * 1.5}rem` }}>
            ...
            <div
              ...
              className="mt-2"
            >
              <NewTaskButton parentId={task._id} />
            </div>
          </div>
        )}
      </div>
